...
namespace Mobius.UAL 
{
	...
	public class DataSourceMx
	{
		...
		public string DatabaseLocator = ""; // Database connection name (e.g. Tnsnames.ora name of Oracle instance to connect to, ODBC connection string, etc)
		...
		public static int LoadMetadata()
		{
			...
			while (node != null)
			{
				 ...
				 Lex.Eq(node.Name, "Connection"))
				{
					...
					else DataSourceMx.DataSources.Add(cd.DataSourceName, cd);
				}
