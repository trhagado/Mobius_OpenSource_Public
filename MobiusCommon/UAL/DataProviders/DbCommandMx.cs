...
namespace Mobius.UAL 
{
	...
	public partial class DbCommandMx
	{
		...
		public string LastSqlFormatted { get { return OracleMx.FormatSql(LastSql); } }
			...
			OracleDbType[] parmArray)
		{
			...
			if (MxConn == null) throw new Exception("Could not get connection, Sql: " + OracleMx.FormatSql(sql));
			...
			catch (Exception ex)
			{
				...
				else
				{
					string msg = "DbCommandMx.Prepare Error:\r\n" +
						ex.Message + "\r\n\r\n" +
						"Sql: " + OracleMx.FormatSql(LastSql);
			...
			int keyCount)
		{
			...
			dsName = mxConn.SessionConn.DataSource.DataSourceName;
