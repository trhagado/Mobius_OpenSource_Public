...
/// </summary>
	...
	public class OracleDao
	{
		...
		public static MetaTable GetMetaTableFromDatabaseDictionary(
			string mtName)
		{
			if (DbConnectionMx.IsSqlFromOracleSource(mtName))
				return GetMetaTableFromOracleDictionary(mtName);

			else if (DbConnectionMx.IsSqlFromOdbcSource(mtName))
				return GetMetaTableFromOdbcDictionary(mtName);
		...
		public static MetaTable GetMetaTableFromOracleDictionary(
			string tableName)
		{
