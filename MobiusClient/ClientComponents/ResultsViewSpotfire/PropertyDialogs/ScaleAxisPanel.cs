...
namespace Mobius.SpotfireClient
{
	public partial class ScaleAxisPanel : DevExpress.XtraEditors.XtraUserControl
	{
		...
		public event EventHandler CallerEditValueChanged; // event to fire back to caller when edit value changes here
...
// Range
			...
			EventArgs e = null)
		{
			...
			if (CallerEditValueChanged != null) // fire EditValueChanged event if handlers present
